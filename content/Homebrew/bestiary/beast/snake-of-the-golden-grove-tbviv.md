...
![Snake of the Golden Grove](Homebrew/bestiary/beast/img/snake-of-the-golden-grove.webp#right|850)  
...
"cr": "18"
"traits":
  - "desc": "The snake eats four golden apples from the grove and regains 42 (4d20) [[hit-points-xphb|Hit Points]] at the start of its turn. If there are no golden apples available for the snake to eat, this trait doesn't function at the start of the snake's next turn."
    "name": "Regeneration"
  - "desc": "Immediately after initiative rolls in which the snake participates, it expects tribute from a creature within 60 feet that it can see, but does not reveal which one or indicate it expects the tribute. Tribute may be paid by bowing, genuflecting, saluting, or a similar gesture. If by the beginning of the snake's first turn in combat the creature it selected has paid it tribute, the snake sheds its skin, and emerges larger and more powerful. Until the end of combat, the snake gains a +3 bonus to damage rolls and Strength and Dexterity checks, gains 315 (30d20) temporary [[hit-points-xphb|Hit Points]], and loses its Regeneration trait."
    "name": "Expect Tribute"
"actions":
...
"source":
  - "TBVIV"
"image": "Homebrew/bestiary/beast/token/snake-of-the-golden-grove-tbviv.webp"
```
^statblock