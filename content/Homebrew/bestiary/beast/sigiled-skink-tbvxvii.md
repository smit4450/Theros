...
![Sigiled Skink](Homebrew/bestiary/beast/img/sigiled-skink.webp#right)  
...
"traits":
  ...
  - "desc": "The skink can take the Disengage or Hide action as a bonus action on each of its turns."
    "name": "Nimble Escape"
  - "desc": "An oracle of Purphoros has [[advantage-xphb|Advantage]] on interpreting the skink's sigils. If the skink dies, the sigils disappear."
    "name": "Sigils"
  - "desc": "The skink has [[advantage-xphb|Advantage]] on ability checks and saving throws made to escape a grapple."
    "name": "Slippery"
"actions":
...
"source":
  - "TBVXVII"
"image": "Homebrew/bestiary/beast/token/sigiled-skink-tbvxvii.webp"
```
^statblock