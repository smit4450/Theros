...
![Hydra Broodmaster](Homebrew/bestiary/monstrosity/img/hydra-broodmaster.webp#right|850)  
...
"traits":
  ...
  - "desc": "The hydra can hold its breath for 1 hour."
    "name": "Hold Breath"
  - "desc": "The hydra has eight heads. While it has more than one head, the hydra has [[advantage-xphb|Advantage]] on saving throws against being [[conditions#Blinded|blinded]], [[conditions#Charmed|charmed]], [[conditions#Deafened|deafened]], [[conditions#Frightened|frightened]], [[conditions#Stunned|stunned]], or knocked [[conditions#Unconscious|unconscious]]. Whenever the hydra takes 185 or more damage in a single turn, one of its heads dies. If all its heads die, the hydra dies. At the end of its turn, it grows two heads for each of its heads that died since its last turn, unless it has taken fire damage since its last turn. The hydra regains 165 [[hit-points-xphb|Hit Points]] for each head regrown in this way."
    "name": "Multiple Heads"
...
"source":
  - "TBVXXIV"
"image": "Homebrew/bestiary/monstrosity/token/hydra-broodmaster-tbvxxiv.webp"
```
^statblock