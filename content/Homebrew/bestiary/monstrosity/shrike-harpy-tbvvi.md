...
![Shrike Harpy](Homebrew/bestiary/monstrosity/img/shrike-harpy.webp#right)  
...
"actions":
  ...
  - "desc": "Melee Weapon Attack: +3 to hit, reach 5 ft., one target. Hit: 3 (1d4 + 1) slashing damage."
    "name": "Claws"
"reactions":
  - "desc": "Immediately after initiative rolls in which the harpy participates, it demands tribute from a creature it can see. That creature may bow, genuflect, salute, or perform a similar gesture as a bonus action. If tribute is paid: Until the end of combat, the harpy gains a +2 bonus to damage rolls and Strength and Dexterity checks, and 9 (2d8) temporary [[hit-points-xphb|Hit Points]]. If tribute isn't paid: The creature becomes [[conditions#Grappled|grappled]] by the harpy (escape DC 11 Strength check). The harpy can carry a Medium or smaller creature with both claws of its feet while flying. A creature that successfully escapes while the harpy is flying falls."
    "name": "Demand Tribute"
"source":
  - "TBVVI"
"image": "Homebrew/bestiary/monstrosity/token/shrike-harpy-tbvvi.webp"
```
^statblock