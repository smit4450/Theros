...
![Fleetfeather Cockatrice](Homebrew/bestiary/monstrosity/img/fleetfeather-cockatrice.webp#right)  
...
"cr": "17"
"traits":
  - "desc": "The cockatrice has [[advantage-xphb|Advantage]] on attack rolls against any creature it has surprised."
    "name": "Ambusher"
  - "desc": "The cockatrice doesn't provoke opportunity attacks when it flies out of an enemy's reach."
    "name": "Flyby"
  - "desc": "The cockatrice can't be [[conditions#Petrified|petrified]] by a member of its own species."
    "name": "Limited Petrification Immunity"
  - "desc": "If the cockatrice is reduced to 0 [[hit-points-xphb|Hit Points]], it doesn’t die or fall [[conditions#Unconscious|unconscious]]. Instead, it sheds its skin, regains 405 (30d20+90) [[hit-points-xphb|Hit Points]], and moves up to its speed without provoking opportunity attacks."
...
"actions":
  ...
  - "desc": "Melee Weapon Attack: +5 to hit, reach 5 ft., one target. Hit: 30 (6d8 + 3) slashing damage."
    "name": "Claws"
  - "desc": "The cockatrice fixes its gaze on one creature within 30 feet of it that the cockatrice can see with both eyes and forces the target to make a DC 13 saving throw. A creature that isn't surprised can use a reaction to Hide and avoid the saving throw. On a failed save, the creature is instantly [[conditions#Petrified|petrified]]. A creature that succeeds on the saving throw begins to turn to stone and is [[conditions#Restrained|restrained]]. The [[conditions#Restrained|restrained]] creature must repeat the saving throw at the end of its next turn, becoming [[conditions#Petrified|petrified]] on a failure or ending the effect on a success. The petrification can only be cured by a god."
    "name": "Death-Darting Eyes"
  - "desc": "_Melee Weapon Attack:_ +5 to hit, reach 60 ft., one target. _Hit:_ 18 (6d4 + 3) bludgeoning damage."
    "name": "Tail"
"source":
  - "TBVIV"
"image": "Homebrew/bestiary/monstrosity/token/fleetfeather-cockatrice-tbviv.webp"
```
^statblock