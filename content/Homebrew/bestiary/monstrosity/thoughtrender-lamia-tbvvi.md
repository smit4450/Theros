...
![Thoughtrender Lamia](Homebrew/bestiary/monstrosity/img/thoughtrender-lamia.webp#right|850)  
...
"cr": "4"
"traits":
  - "desc": "The lamia can't use its blindsight while [[conditions#Deafened|deafened]] and unable to smell."
    "name": "Blind Senses"
  - "desc": "The lamia has [[advantage-xphb|Advantage]] on melee attack rolls against any creature that doesn't have all its [[hit-points-xphb|Hit Points]]."
    "name": "Blood Frenzy"
  - "desc": "The lamia has [[advantage-xphb|Advantage]] on saving throws against spells and other magical effects."
...
"source":
  - "TBVVI"
"image": "Homebrew/bestiary/monstrosity/token/thoughtrender-lamia-tbvvi.webp"
```
^statblock