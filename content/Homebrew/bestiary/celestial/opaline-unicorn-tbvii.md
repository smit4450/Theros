...
![Opaline Unicorn](Homebrew/bestiary/celestial/img/opaline-unicorn.webp#right)  
...
"cr": "5"
"traits":
  - "desc": "If the unicorn moves at least 20 ft. straight toward a target and then hits it with a horn attack on the same turn, the target takes an extra 9 (2d8) piercing damage. If the target is a creature, it must succeed on a DC 15 Strength saving throw or be knocked [[conditions#Prone|prone]]."
    "name": "Charge"
  ...
  - "desc": "When the unicorn takes a long rest, it must spend at least six hours in an active, motionless state, rather than sleeping. In this state, the unicorn appears inert, but the rest doesn't render it [[conditions#Unconscious|unconscious]], and it can see and hear as normal."
    "name": "Sentry's Rest"
"actions":
...
"source":
  - "TBVII"
"image": "Homebrew/bestiary/celestial/token/opaline-unicorn-tbvii.webp"
```
^statblock