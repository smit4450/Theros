...
![Arbor Colossus](Homebrew/bestiary/giant/img/arbor-colossus.webp#right|850)  
...
"traits":
  ...
  - "desc": "When the colossus is reduced to 0 [[hit-points-xphb|Hit Points]], it doesn’t die or fall [[conditions#Unconscious|unconscious]]. Instead, the damage creates tears in its skin, revealing its hearts. The colossus has three hearts in its chest. A heart has an AC of 16 and 165 [[hit-points-xphb|Hit Points]]. It is immune to all conditions. If it is forced to make a saving throw, treat its ability scores as 10 (+0). The colossus dies when all the hearts are destroyed."
...
"source":
  - "TBVIX"
"image": "Homebrew/bestiary/giant/token/arbor-colossus-tbvix.webp"
```
^statblock