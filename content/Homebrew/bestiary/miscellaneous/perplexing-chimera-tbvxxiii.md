...
![Perplexing Chimera](Homebrew/bestiary/miscellaneous/img/perplexing-chimera.webp#right|850)  
...
"traits":
  ...
  - "desc": "The chimera glows with the soft light of the night sky, shedding dim light in a 15-foot radius."
    "name": "Starlight Form"
  - "desc": "The chimera has [[advantage-xphb|Advantage]] on saving throws against being [[conditions#Blinded|blinded]], [[conditions#Charmed|charmed]], [[conditions#Deafened|deafened]], [[conditions#Frightened|frightened]], [[conditions#Stunned|stunned]], and knocked [[conditions#Unconscious|unconscious]]."
    "name": "Two Heads"
"actions":
  - "desc": "The chimera makes two attacks against a single target: one with its bite and one with its talons."
    "name": "Multiattack"
  - "desc": "Melee Weapon Attack: +3 to hit, reach 5 ft., one target. Hit: 12 (2d8 + 3) piercing damage. If the target is a creature, it must succeed on a DC 15 Strength saving throw or be knocked [[conditions#Prone|prone]]."
    "name": "Bite"
  - "desc": "Melee Weapon Attack: +5 to hit, reach 5 ft., one target. Hit: 10 (2d6 + 3) slashing damage."
    "name": "Talons"
"source":
  - "TBVXXIII"
"image": "Homebrew/bestiary/miscellaneous/token/perplexing-chimera-tbvxxiii.webp"
```
^statblock