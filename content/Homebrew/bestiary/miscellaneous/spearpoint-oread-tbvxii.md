...
![Spearpoint Oread](Homebrew/bestiary/miscellaneous/img/spearpoint-oread.webp#right|850)  
...
"traits":
  - "desc": "The oread can move across difficult terrain made of earth or stone without expending extra movement."
    "name": "Earth Walk"
  - "desc": "The oread's innate spellcasting ability is Charisma (spell save DC 14, +6 to hit with spell attacks). It can innately cast the following spells, requiring no material components: At will: [[passwall-xphb|Passwall]], [[find-the-path-xphb|Find The Path]] 3/day: [[stone-shape-xphb|Stone Shape]] 1/day: [[hallucinatory-terrain-xphb|Hallucinatory Terrain]], [[wall-of-stone-xphb|Wall Of Stone]], [[creation-xphb|Creation]]"
...
"source":
  - "TBVXII"
"image": "Homebrew/bestiary/miscellaneous/token/spearpoint-oread-tbvxii.webp"
```
^statblock