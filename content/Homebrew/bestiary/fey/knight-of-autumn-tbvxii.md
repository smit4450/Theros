...
![Knight of Autumn](Homebrew/bestiary/fey/img/knight-of-autumn.webp#right)  
...
"cr": "5"
"traits":
  - "desc": "If the knight is mounted and moves at least 20 feet straight toward a target and then hits it with a lance attack on the same turn, that target must succeed on a DC 15 Strength saving throw or be knocked [[conditions#Prone|prone]]."
    "name": "Mounted Charge"
...
"source":
  - "TBVXII"
"image": "Homebrew/bestiary/fey/token/knight-of-autumn-tbvxii.webp"
```
^statblock