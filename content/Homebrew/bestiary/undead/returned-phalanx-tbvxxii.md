...
![Returned Phalanx](Homebrew/bestiary/undead/img/returned-phalanx.webp#right|850)  
...
"traits":
  - "desc": "While the phalanx is holding a a spear, javelin, or pike, other creatures provoke an opportunity attack from the phalanx when they move within 5 feet of it. When the phalanx hits a creature with an opportunity attack using its spear, javelin, or pike, the creature takes an extra 4 (1d8) piercing damage, and the creature’s speed becomes 0 for the rest of the turn."
    "name": "Hold the Line"
  - "desc": "The returned phalanx has [[advantage-xphb|Advantage]] on saving throws against being [[conditions#Blinded|blinded]], [[conditions#Charmed|charmed]], [[conditions#Deafened|deafened]], [[conditions#Frightened|frightened]], [[conditions#Stunned|stunned]], and knocked [[conditions#Unconscious|unconscious]]."
    "name": "Multiple Heads"
  ...
  - "desc": "The phalanx has [[advantage-xphb|Advantage]] on saving throws against any effect that turns undead."
    "name": "Turn Resistance"
  - "desc": "The phalanx is immune to any effect that would sense its emotions or read its thoughts. Wisdom (Insight) checks to ascertain the merchant's intentions or sincerity are made with [[disadvantage-xphb|Disadvantage]]."
...
"source":
  - "TBVXXII"
"image": "Homebrew/bestiary/undead/token/returned-phalanx-tbvxxii.webp"
```
^statblock