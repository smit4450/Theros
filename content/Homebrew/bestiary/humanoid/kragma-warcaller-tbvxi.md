...
![Kragma Warcaller](Homebrew/bestiary/humanoid/img/kragma-warcaller.webp#right)  
...
"traits":
  ...
  - "desc": "Other minotaur creatures within 30 feet of the warcaller that can see or hear it have [[advantage-xphb|Advantage]] on initiative rolls and have a +2 bonus on damage rolls and Strength and Dexterity checks."
...
"source":
  - "TBVXI"
"image": "Homebrew/bestiary/humanoid/token/kragma-warcaller-tbvxi.webp"
```
^statblock