...
![Oracle of Bones](Homebrew/bestiary/humanoid/img/oracle-of-bones.webp#right|850)  
...
"cr": "1"
"traits":
  - "desc": "The oracle has [[advantage-xphb|Advantage]] on initiative rolls."
  ...
  - "desc": "The oracle of bones is a 9th-level spellcaster. The oracle of bones's spellcasting ability is Wisdom (spell save DC 13, +5 to hit with spell attacks). The oracle of bones has the following cleric spells prepared: Cantrip (at will): _guidance_, [[sacred-flame-xphb|Sacred Flame]], [[spare-the-dying-xphb|Spare The Dying]] 2nd level (3 slots): [[augury-xphb|Augury]] 4th level (3 slots): [[divination-xphb|Divination]] 5th level (1 slots): _commune_"
    "name": "Spellcasting"
"actions":
...
"reactions":
  ...
  - "desc": "Immediately after initiative rolls in which the oracle participates, it demands tribute from a creature it can see. That creature may bow, genuflect, salute, or perform a similar gesture as a bonus action. If tribute is paid: Until the end of combat, the oracle gains a +2 bonus to damage rolls and Strength and Dexterity checks, and 9 (2d8) temporary [[hit-points-xphb|Hit Points]]. If tribute isn't paid: The oracle casts a [[sacred-flame-xphb|Sacred Flame]] on that creature."
    "name": "Demand Tribute"
"source":
  - "TBVXX"
"image": "Homebrew/bestiary/humanoid/token/oracle-of-bones-tbvxx.webp"
```
^statblock