...
![Setessan Battle Priest](Homebrew/bestiary/humanoid/img/setessan-battle-priest.webp#right)  
...
"source":
  - "TBVXVI"
"image": "Homebrew/bestiary/humanoid/token/setessan-battle-priest-tbvxvi.webp"
```
^statblock