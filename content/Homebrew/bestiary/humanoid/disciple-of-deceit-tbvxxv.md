...
![Disciple of Deceit](Homebrew/bestiary/humanoid/img/disciple-of-deceit.webp#right|850)  
...
"actions":
  - "desc": "_Melee or Ranged Weapon Attack:_ +6 to hit, reach 5 ft. or range 20/60 ft., one target. _Hit:_ 4 (1d4 + 2) piercing damage."
    "name": "Dagger"
  - "desc": "The disciple bows down to any manifestation or statue of Phenax that it can see. It remains in this position until a different action is used."
    "name": "Bow"
"source":
  - "TBVXXV"
"image": "Homebrew/bestiary/humanoid/token/disciple-of-deceit-tbvxxv.webp"
```
^statblock