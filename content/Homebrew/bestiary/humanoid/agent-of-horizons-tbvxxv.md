...
![Agent of Horizons](Homebrew/bestiary/humanoid/img/agent-of-horizons.webp#right|850)  
...
"traits":
  - "desc": "On each of its turns, the spy can use a bonus action to take the Dash, Disengage, or Hide action."
    "name": "Cunning Action"
  - "desc": "The spy deals an extra 7 (2d6) damage when it hits a target with a weapon attack and has [[advantage-xphb|Advantage]] on the attack roll, or when the target is within 5 ft. of an ally of the spy that isn't [[conditions#Incapacitated|incapacitated]] and the spy doesn't have [[disadvantage-xphb|Disadvantage]] on the attack roll."
...
"source":
  - "TBVXXV"
"image": "Homebrew/bestiary/humanoid/token/agent-of-horizons-tbvxxv.webp"
```
^statblock