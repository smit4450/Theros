...
On a failed save, the target has [[disadvantage-xphb|Disadvantage]] on Strength-based [[d20-test-xphb|D20 Tests]] for the duration. During that time, it also subtracts `1d8` from all its damage rolls. The target repeats the save at the end of each of its turns, ending the spell on a success.
