...
As a [Magic](/Compendium/rules/actions.md#Magic) action, you can make a melee spell attack with the fiery blade. On a hit, the target takes Fire damage equal to `3d6` plus your spellcasting ability modifier.

The flaming blade sheds [Bright Light](/Compendium/rules/variant-rules/bright-light-xphb.md) in a 10-foot radius and [Dim Light](/Compendium/rules/variant-rules/dim-light-xphb.md) for an additional 10 feet.
