...
Eight rays of light flash from you in a 60-foot [[cone-area-of-effect-xphb|Cone]]. Each creature in the [[cone-area-of-effect-xphb|Cone]] makes a Dexterity saving throw. For each target, roll `1d8` to determine which color ray affects it, consulting the Prismatic Rays table.
