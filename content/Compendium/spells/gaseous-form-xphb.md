...
While in this form, the target's only method of movement is a [[fly-speed-xphb|Fly Speed]] of 10 feet, and it can hover. The target can enter and occupy the space of another creature. The target has [[resistance-rules-xphb|Resistance]] to Bludgeoning, Piercing, and Slashing damage; it has [[immunity-xphb|Immunity]] to the [[conditions#Prone|Prone]] condition; and it has [[advantage-xphb|Advantage]] on Strength, Dexterity, and Constitution saving throws. The target can pass through narrow openings, but it treats liquids as though they were solid surfaces.
