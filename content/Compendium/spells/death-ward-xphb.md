...
You touch a creature and grant it a measure of protection from death. The first time the target would drop to 0 [Hit Points](/Compendium/rules/variant-rules/hit-points-xphb.md) before the spell ends, the target instead drops to 1 [Hit Point](/Compendium/rules/variant-rules/hit-points-xphb.md), and the spell ends.
