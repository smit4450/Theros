...
# Jallarzi's Storm of Radiance
*5th-level, Evocation*  
![](/Compendium/spells/img/jallarzis-storm-of-radiance.webp#right)
...
You unleash a storm of flashing light and raging thunder in a 10-foot-radius, 40-foot-high [Cylinder](/Compendium/rules/variant-rules/cylinder-area-of-effect-xphb.md) centered on a point you can see within range. While in this area, creatures have the [Blinded](/Compendium/rules/conditions.md#Blinded) and [Deafened](/Compendium/rules/conditions.md#Deafened) conditions, and they can't cast spells with a Verbal component.
...
**Classes**: [Bard](/Compendium/lists/list-spells-classes-bard.md); [Warlock](/Compendium/lists/list-spells-classes-warlock.md); [Wizard (Evoker)](/Compendium/lists/list-spells-classes-evoker-xphb.md "subclass=XPHB;class=XPHB"); [Wizard](/Compendium/lists/list-spells-classes-wizard.md)
