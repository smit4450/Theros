...
- Choose one ability. The target has [Disadvantage](/Compendium/rules/variant-rules/disadvantage-xphb.md) on ability checks and saving throws made with that ability.  
- The target has [Disadvantage](/Compendium/rules/variant-rules/disadvantage-xphb.md) on attack rolls against you.  
- In combat, the target must succeed on a Wisdom saving throw at the start of each of its turns or be forced to take the [Dodge](/Compendium/rules/actions.md#Dodge) action on that turn.  
