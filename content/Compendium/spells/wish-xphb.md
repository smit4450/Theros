...
- **Resistance.** You grant up to ten creatures that you can see [[resistance-rules-xphb|Resistance]] to one damage type that you choose. This [[resistance-rules-xphb|Resistance]] is permanent.  
...
The stress of casting Wish to produce any effect other than duplicating another spell weakens you. After enduring that stress, each time you cast a spell until you finish a [[long-rest-xphb|Long Rest]], you take `1d10` Necrotic damage per level of that spell. This damage can't be reduced or prevented in any way. In addition, your Strength score becomes 3 for `2d4` days. For each of those days that you spend resting and doing nothing more than light activity, your remaining recovery time decreases by 2 days. Finally, there is a  chance that you are unable to cast [[wish-xphb|Wish]] ever again if you suffer this stress.
