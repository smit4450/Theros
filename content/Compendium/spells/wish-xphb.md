...
- **Instant Health.** You allow yourself and up to twenty creatures that you can see to regain all [Hit Points](/Compendium/rules/variant-rules/hit-points-xphb.md), and you end all effects on them listed in the [Greater Restoration](/Compendium/spells/greater-restoration-xphb.md) spell.  
- **Resistance.** You grant up to ten creatures that you can see [Resistance](/Compendium/rules/variant-rules/resistance-xphb.md) to one damage type that you choose. This [Resistance](/Compendium/rules/variant-rules/resistance-xphb.md) is permanent.  
...
- **Roll Redo.** You undo a single recent event by forcing a reroll of any die roll made within the last round (including your last turn). Reality reshapes itself to accommodate the new result. For example, a Wish spell could undo an ally's failed saving throw or a foe's [Critical Hit](/Compendium/rules/variant-rules/critical-hit-xphb.md). You can force the reroll to be made with [Advantage](/Compendium/rules/variant-rules/advantage-xphb.md) or [Disadvantage](/Compendium/rules/variant-rules/disadvantage-xphb.md), and you choose whether to use the reroll or the original roll.  
