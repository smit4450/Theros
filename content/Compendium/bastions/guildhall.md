...
| Shipbuilders' Guild | Crossed oars | You assign shipbuilders to build one of the vehicles in the [[large-vehicles-airborne-and-waterborne-vehicles-xphb|Airborne and Waterborne Vehicles]] table of the "Player's Handbook". You pay the full cost of the vehicle, and the work takes 1 day per 1,000 GP of the vehicle's cost (a [[rowboat-xphb|Rowboat]] can be made in 1 day). |
