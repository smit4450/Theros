...
"cr": "16"
"traits":
  - "desc": "When the cyclops is reduced to 0 hit points, it doesn’t die or fall unconscious. Instead, the damage creates tears in its skin, revealing its hearts. The cyclops has three hearts in its chest. A heart has an AC of 14 and 135 hit points. It is immune to all conditions. If it is forced to make a saving throw, treat its ability scores as 10 (+0). The cyclops dies when all the hearts are destroyed."
  ...
  - "desc": "The cyclops can move in and out of a Huge or smaller creature's space. If it would, it uses a bonus action to attack that creature with its unarmed strike. That creature must succeed on a DC 13 Strength saving throw or be knocked prone. If the creature succeeds, the cyclops can't enter that space and must end its turn immediately. If the cyclops stops on top of that creature, that creature becomes restrained until the cyclops moves off it (escape DC 13)."
    "name": "Trample"
"actions":
...
"source":
  - "TBVIX"
"image": "Compendium/bestiary/giant/token/ill-tempered-cyclops-tbvix.webp"
```
^statblock