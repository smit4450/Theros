...
"traits":
  ...
  - "desc": "The cyclops can move in and out of a Huge or smaller creature's space. If it would, it uses a bonus action to attack that creature with its unarmed strike. That creature must succeed on a DC 15 Strength saving throw or be knocked prone. If the creature succeeds, the cyclops can't enter that space and must end its turn immediately. If the cyclops stops on top of that creature, that creature becomes restrained until the cyclops moves off it (escape DC 15)."
    "name": "Trample"
"actions":
