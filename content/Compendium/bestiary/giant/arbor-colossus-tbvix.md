...
"traits":
  ...
  - "desc": "When the colossus is reduced to 0 hit points, it doesn’t die or fall unconscious. Instead, the damage creates tears in its skin, revealing its hearts. The colossus has three hearts in its chest. A heart has an AC of 16 and 165 hit points. It is immune to all conditions. If it is forced to make a saving throw, treat its ability scores as 10 (+0). The colossus dies when all the hearts are destroyed."
