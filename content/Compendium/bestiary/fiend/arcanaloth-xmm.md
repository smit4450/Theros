...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +9, reach 5 ft. *Hit:* 10 (2d4 + 5) Slashing damage\
      ...
      \ tome and can escape only if the tome is reduced to 0 [Hit Points](/Compendium/rules/variant-rules/hit-points-xphb.md)."
  ...
  - "desc": "The arcanaloth casts one of the following spells, requiring no Material\
      ...
      \ [Detect Thoughts](/Compendium/spells/detect-thoughts-xphb.md), [Dimension\
      \ Door](/Compendium/spells/dimension-door-xphb.md), [Mind Blank](/Compendium/spells/mind-blank-xphb.md)"
    "name": "Spellcasting"
"bonus_actions":
