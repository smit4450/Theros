...
"cr": "9"
"traits":
  - "desc": "At the beginning of its turn, the demon moves up to its speed and eats\
      \ a willing harpy. If it can't, it spends its turns trying to isolate itself\
      \ from as many creatures possible."
    "name": "Better Things to Do"
  - "desc": "When the demon first appears, it is surrounded by 7 (2d6) **abhorrent\
      \ harpies** that are friendly to one another and to the demon."
