...
"actions":
  - "desc": "*Melee Attack Roll:* +5, reach 5 ft. *Hit:* 16 (4d6 + 2) Piercing damage\
      \ plus 21 (6d6) Necrotic damage. If the target is a creature, its [Hit Point](/Compendium/rules/variant-rules/hit-points-xphb.md)\
...
"bonus_actions":
  - "desc": "*Constitution Saving Throw:* DC 12, each creature in a 30-foot [Emanation](/Compendium/rules/variant-rules/emanation-area-of-effect-xphb.md)\
      ...
      \ within 5 feet of it takes an action to empty a flask of [Holy Water](/Compendium/items/holy-water-xphb.md)\
