...
```ad-statblock
title: Dretch
![](/Compendium/bestiary/fiend/token/dretch-xmm.webp#token)
...
***Fetid Cloud (1/Day).*** *Constitution Saving Throw:* DC 11, each creature in a 10-foot [Emanation](/Compendium/rules/variant-rules/emanation-area-of-effect-xphb.md) originating from the dretch. *Failure:* The target has the [Poisoned](/Compendium/rules/conditions.md#Poisoned) condition until the end of its next turn. While [Poisoned](/Compendium/rules/conditions.md#Poisoned), the creature can take either an action or a [Bonus Action](/Compendium/rules/variant-rules/bonus-action-xphb.md) on its turn, not both, and it can't take Reactions.
```
^statblock
