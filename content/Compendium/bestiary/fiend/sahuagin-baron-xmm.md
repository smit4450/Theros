...
"gear":
  ...
  - "[trident](/Compendium/items/trident-xphb.md)"
...
"reactions":
  - "desc": "Trigger: The sahuagin takes Piercing or Slashing damage. _Response—_*Constitution\
      ...
      \ is cursed until it finishes a [Short](/Compendium/rules/variant-rules/short-rest-xphb.md)\
...
"source":
  - "XMM"
"image": "/Compendium/bestiary/fiend/token/sahuagin-baron-xmm.webp"
```
^statblock
