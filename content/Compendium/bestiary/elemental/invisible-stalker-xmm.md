...
![](/Compendium/bestiary/elemental/token/invisible-stalker-xmm.webp#token)
...
- **Proficiency Bonus** +3
- **Saving Throws** ⏤
- **Skills** [Perception](/Compendium/rules/skills.md#Perception) +8, [Stealth](/Compendium/rules/skills.md#Stealth) +10
...
***Invisibility.*** The stalker has the [Invisible](/Compendium/rules/conditions.md#Invisible) condition.
