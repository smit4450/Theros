...
"actions":
  ...
  - "desc": "The cataclysm creates one of the following effects at random (roll 1d4):\n\
      ...
      \ Half damage only. *Failure or Success:* The target's [Speed](/Compendium/rules/variant-rules/speed-xphb.md)\
      ...
      \ DC 23, each creature in a 90-foot [Cube](/Compendium/rules/variant-rules/cube-area-of-effect-xphb.md)\
