...
"condition_immunities": "[exhaustion](Compendium/rules/conditions.md#Exhaustion), [grappled](Compendium/rules/conditions.md#Grappled), [paralyzed](Compendium/rules/conditions.md#Paralyzed), [poisoned](Compendium/rules/conditions.md#Poisoned), [prone](Compendium/rules/conditions.md#Prone), [restrained](Compendium/rules/conditions.md#Restrained), [unconscious](Compendium/rules/conditions.md#Unconscious)"
"senses": "[Blindsight](Compendium/rules/senses.md#Blindsight) 30ft., passive Perception 10"
"languages": ""
"cr": "3"
"traits":
  - "desc": "If the elemental takes cold damage, it partially freezes; its speed is reduced by 20 feet until the end of its next turn."
    "name": "Freeze"
  - "desc": "The elemental is [invisible](Compendium/rules/conditions.md#Invisible) while fully immersed in water."
    "name": "Invisible in Water"
  - "desc": "If the elemental moves at least 20 feet straight toward a creature and then hits it with a hooves attack on the same turn, that target must succeed on a DC 12 Strength saving throw or be knocked [prone](Compendium/rules/conditions.md#Prone). If the target is [prone](Compendium/rules/conditions.md#Prone), the elemental can make another attack with its hooves against it as a bonus action."
