...
![](/Compendium/books/monster-manual-2025/img/magmin.webp#right)
...
```ad-statblock
title: Magmin
![](/Compendium/bestiary/elemental/token/magmin-xmm.webp#token)
...
***Death Burst.*** The magmin explodes when it dies. *Dexterity Saving Throw:* DC 11, each creature in a 10-foot [Emanation](/Compendium/rules/variant-rules/emanation-area-of-effect-xphb.md) originating from the magmin. *Failure:* 7 (`2d6`) Fire damage. *Success:* Half damage.
...
***Ignited Illumination.*** The magmin sets itself ablaze or extinguishes its flames. While ablaze, the magmin sheds [Bright Light](/Compendium/rules/variant-rules/bright-light-xphb.md) in a 10-foot radius and [Dim Light](/Compendium/rules/variant-rules/dim-light-xphb.md) for an additional 10 feet.
```
^statblock
