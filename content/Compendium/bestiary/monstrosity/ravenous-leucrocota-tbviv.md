...
"cr": "3"
"traits":
  - "desc": "The leucrocota has [Advantage](Compendium/rules/variant-rules/advantage-xphb.md) on Wisdom (perception) checks that rely on smell."
    "name": "Keen Smell"
  ...
  - "desc": "The leucrocota can mimic animal sounds and humanoid voices. A creature that hears the sounds can tell they are imitations with a successful DC 14 Wisdom (Insight) check."
    "name": "Mimicry"
  - "desc": "When the leucrocota reduces a creature to 0 [Hit Points](Compendium/rules/variant-rules/hit-points-xphb.md) with a melee attack on its turn, it can take a bonus action to move up to half its speed and make an attack with its hooves."
    "name": "Rampage"
...
"actions":
  ...
  - "desc": "Melee Weapon Attack: +4 to hit, reach 5 ft., one target. Hit: 9 (2d6 + 2) bludgeoning damage."
    "name": "Hooves"
  - "desc": "The leucrocota devours a corpse it can reach. It gets a +3 bonus to Strength and Dexterity checks and damage rolls, and gains 16 (3d10) temporary [Hit Points](Compendium/rules/variant-rules/hit-points-xphb.md). This effect ends when the leucrocota completes a Short or Long Rest."
