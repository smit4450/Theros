...
"bonus_actions":
  - "desc": "The weretiger moves up to its [Speed](/Compendium/rules/variant-rules/speed-xphb.md)\
      ...
      \ At the end of this movement, the weretiger can take the [Hide](/Compendium/rules/actions.md#Hide)\
      \ action."
...
"source":
  - "XMM"
"image": "/Compendium/bestiary/monstrosity/token/weretiger-xmm.webp"
```
^statblock
