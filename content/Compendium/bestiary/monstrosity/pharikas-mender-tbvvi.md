...
"traits":
  ...
  - "desc": "The mender's innate spellcasting ability is Charisma (spell save DC 15, +7 to hit with spell attacks). It can innately cast the following spells, requiring no material components: At will: _spare the dying_ 3/day: _cure wounds_, _lesser restoration_, _protection from poison_ 1/day: _revivify_"
...
"actions":
  - "desc": "The gorgon makes two attacks: one to constrict, and one with its shortsword."
    "name": "Multiattack"
  - "desc": "Melee Weapon Attack: +3 to hit, reach 10 ft., one target. Hit: 7 (2d6) bludgeoning damage, and the target is grappled (escape DC 10) if it is a Large or smaller creature. Until this grapple ends, the target is restrained, and the gorgon can’t constrict another target."
    "name": "Constrict"
