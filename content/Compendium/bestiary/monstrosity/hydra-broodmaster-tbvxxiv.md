...
![](/Compendium/bestiary/monstrosity/img/hydra-broodmaster.webp#center)
...
- **Hit Points** 1440 (`80d20 + 640`) 
- **Speed** 40 ft., swim 40 ft.

|STR|DEX|CON|INT|WIS|CHA|
|:---:|:---:|:---:|:---:|:---:|:---:|
|26 (+8)|10 (+0)|26 (+8)| 2 (-4)|10 (+0)| 7 (-2)|
...
***Hatch Brood (Mythic Trait).*** The hydra guards a nest of golden eggs that are about to hatch.

## Actions

***Multiattack.*** The hydra makes as many bite attacks as it has heads.

***Bite.*** Melee Weapon Attack: +19 to hit, reach 15 ft., one target. Hit: 60 (12d8 + 6) piercing damage.
```
^statblock