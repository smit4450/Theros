...
"traits":
  ...
  - "desc": "The gorgon has advantage on saving throws against spells and other magical effects."
...
"actions":
  - "desc": "The gorgon makes either three melee attacks—one with its snake hair, one to constrict, and one with its shortsword—or two ranged attacks with its longbow."
    "name": "Multiattack"
  - "desc": "Melee Weapon Attack: +3 to hit, reach 10 ft., one target. Hit: 7 (2d6) bludgeoning damage, and the target is grappled (escape DC 11) if it is a Large or smaller creature. Until this grapple ends, the target is restrained, and the gorgon can’t constrict another target."
    "name": "Constrict"
