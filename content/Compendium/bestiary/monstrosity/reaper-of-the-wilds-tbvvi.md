...
"traits":
  ...
  - "desc": "The reaper has advantage on saving throws against spells and other magical effects."
...
"actions":
  - "desc": "Melee Weapon Attack: +7 to hit, reach 5 ft., one creature. Hit: 4 (1d4 + 6) bludgeoning damage."
    "name": "Snake Hair"
  - "desc": "Melee Weapon Attack: +7 to hit, reach 10 ft., one target. Hit: 7 (2d6) bludgeoning damage, and the target is grappled (escape DC 18) if it is a Large or smaller creature. Until this grapple ends, the target is restrained, and the reaper can’t constrict another target."
    "name": "Constrict"
"reactions":
  - "desc": "Whenever a creature within 30 feet of the reaper is reduced to 0 hit points or becomes incapacitated or petrified, the reaper may reroll one die and choose either value rolled when it makes its next ability check, attack roll, or saving throw."
