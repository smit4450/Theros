...
aliases:
- "Chorister of the Tides"
---
# Chorister of the Tides
*Source: Theros Bestiary, Vol. VI*  
![](/Compendium/bestiary/monstrosity/img/chorister-of-the-tides.webp#center)

```ad-statblock
title: Chorister of the Tides
*Medium monstrosity (siren), Chaotic Evil*
...
***Heroic.*** Whenever the chorister becomes targeted by a spell, that spell's caster chooses whether the following happens: Until the end of the chorister's next turn, whenever it uses its luring song, its song reaches 10 additional feet.
