...
"actions":
  ...
  - "desc": "*Dexterity Saving Throw:* DC 25, one creature [[conditions#Grappled|Grappled]]\
      ...
      \ the kraken with the [[conditions#Prone|Prone]] condition.\
      \ If the kraken dies, any swallowed creature no longer has the [[conditions#Restrained|Restrained]]\
...
"regional_effects":
  - "desc": "The region containing a kraken's lair is twisted by its presence, creating\
      ...
      \ [[conditions#Charmed|Charmed]] condition while in that\
      \ area.  \n- **Sea and Storms.** While in its lair, the kraken can cast [[control-weather-xphb|Control\
      \ Weather]], requiring no spell components\
