...
"bonus_actions":
  - "desc": "*Strength Saving Throw:* DC 19, one Large or smaller creature [Grappled](/Compendium/rules/conditions.md#Grappled)\
      ...
      \ the [Prone](/Compendium/rules/conditions.md#Prone) condition. If the worm\
      \ dies, any swallowed creature no longer has the [Restrained](/Compendium/rules/conditions.md#Restrained)\
