...
![](/Compendium/bestiary/monstrosity/token/yuan-ti-malison-type-1-xmm.webp#token)
...
***Multiattack.*** The yuan-ti makes two attacks, using Bite or Poison Ray in any combination, and it can use Spellcasting to cast [Suggestion](/Compendium/spells/suggestion-xphb.md) if available.
