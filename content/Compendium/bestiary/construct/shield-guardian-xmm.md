...
![](/Compendium/bestiary/construct/token/shield-guardian-xmm.webp#token)
...
***Regeneration.*** The guardian regains 10 [Hit Points](/Compendium/rules/variant-rules/hit-points-xphb.md) at the start of each of its turns if it has at least 1 [Hit Point](/Compendium/rules/variant-rules/hit-points-xphb.md).
