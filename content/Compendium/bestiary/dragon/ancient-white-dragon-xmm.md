...
![An ancient white dragon freezes a ship full of trespassers before they set foot in its territory](/Compendium/bestiary/dragon/img/ancient-white-dragon.webp#right)
...
"regional_effects":
  - "desc": "The region containing an adult or ancient white dragon's lair is affected\
      ...
      \ area within 1 mile of the lair is an area of [extreme cold](/Compendium/traps-hazards/extreme-cold-xdmg.md).\
      \ Any water in that area is [frigid water](/Compendium/traps-hazards/frigid-water-xdmg.md).\
      \ See the \"Dungeon Master's Guide\" for rules on extreme cold and frigid water.\
      \  \n- **Glacial Gloom.** The area within 1 mile of the lair is [Lightly Obscured](/Compendium/rules/variant-rules/lightly-obscured-xphb.md)\
      \ by chilly fog. Whenever a creature other than the dragon or one of its allies\
      \ finishes a [Long Rest](/Compendium/rules/variant-rules/long-rest-xphb.md)\
      \ in that area, that creature must succeed on a DC 15 Constitution saving throw\
      \ or have its [Speed](/Compendium/rules/variant-rules/speed-xphb.md) reduced\
...
"legendary_actions":
  - "desc": "*Constitution Saving Throw:* DC 20, each creature in a 30-foot-radius\
      ...
      \ and the target's [Speed](/Compendium/rules/variant-rules/speed-xphb.md) is\
  ...
  - "desc": "The dragon moves up to half its [Speed](/Compendium/rules/variant-rules/speed-xphb.md),\
    ...
    "name": "Pounce"
  - "desc": "The dragon casts [Fear](/Compendium/spells/fear-xphb.md), requiring no\
...
"source":
  - "XMM"
"image": "/Compendium/bestiary/dragon/token/ancient-white-dragon-xmm.webp"
```
^statblock
