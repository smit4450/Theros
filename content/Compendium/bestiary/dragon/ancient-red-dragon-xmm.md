...
![Even the bravest souls flee the onslaught of an ancient red dragon](/Compendium/bestiary/dragon/img/ancient-red-dragon.webp#right)
...
"actions":
  ...
  - "desc": "The dragon casts one of the following spells, requiring no Material components\
      ...
      \n**1/day each:** [Fireball](/Compendium/spells/fireball-xphb.md) (level 6 version),\
...
"source":
  - "XMM"
"image": "/Compendium/bestiary/dragon/token/ancient-red-dragon-xmm.webp"
```
^statblock
