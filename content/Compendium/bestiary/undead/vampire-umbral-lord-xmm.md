...
"traits":
  ...
  - "desc": "If the vampire drops to 0 [Hit Points](Compendium/rules/variant-rules/hit-points-xphb.md)\
      ...
      \ inside its resting place, it has the [Paralyzed](Compendium/rules/conditions.md#Paralyzed)\
      \ condition for 1 hour, after which it regains 1 [Hit Point](Compendium/rules/variant-rules/hit-points-xphb.md)."
    "name": "Shadow Escape"
...
"bonus_actions":
  - "desc": "*Constitution Saving Throw:* DC 18, one creature the vampire can see\
      ...
      \ Necrotic damage. The target's [Hit Point](Compendium/rules/variant-rules/hit-points-xphb.md)\
...
"source":
  - "XMM"
"image": "Compendium/bestiary/undead/token/vampire-umbral-lord-xmm.webp"
```
^statblock