...
"traits":
  ...
  - "desc": "The centaur has [Advantage](Compendium/rules/variant-rules/advantage-xphb.md) on saving throws against any effect that turns undead."
    "name": "Turn Resistance"
  - "desc": "The centaur is immune to any effect that would sense its emotions or read its thoughts. Wisdom (Insight) checks to ascertain the centaur's intentions or sincerity are made with [Disadvantage](Compendium/rules/variant-rules/disadvantage-xphb.md)."
