...
![](/Compendium/books/monster-manual-2025/img/death-tyrant.webp#right)
...
"actions":
  ...
  - "desc": "The death tyrant randomly shoots one of the following magical rays at\
      ...
      \ target has the [Charmed](/Compendium/rules/conditions.md#Charmed) condition\
      ...
      \ has the [Paralyzed](/Compendium/rules/conditions.md#Paralyzed) condition and\
      ...
      \ its [Speed](/Compendium/rules/variant-rules/speed-xphb.md) is halved; and\
      \ it can take either an action or a [Bonus Action](/Compendium/rules/variant-rules/bonus-action-xphb.md)\
      ...
      \ has the [Restrained](/Compendium/rules/conditions.md#Restrained) condition\
      ...
      \ Construct or an Undead). *Failure:* The target has the [Unconscious](/Compendium/rules/conditions.md#Unconscious)\
...
"bonus_actions":
  - "desc": "The death tyrant's central eye emits an imperceptible, magical wave of\
      \ negative energy in a 150-foot [Cone](/Compendium/rules/variant-rules/cone-area-of-effect-xphb.md).\
      \ Creatures in that area can't regain [Hit Points](/Compendium/rules/variant-rules/hit-points-xphb.md)\
      \ until the start of the death tyrant's next turn. An intact Humanoid corpse\
      \ there instantly rises as a [Zombie](/Compendium/bestiary/undead/zombie-xmm.md)\
...
"regional_effects":
  - "desc": "The region containing a death tyrant's lair is warped by its presence,\
      ...
      \ allies) that finishes a [Short Rest](/Compendium/rules/variant-rules/short-rest-xphb.md)\
...
"source":
  - "XMM"
"image": "/Compendium/bestiary/undead/token/death-tyrant-xmm.webp"
```
^statblock
