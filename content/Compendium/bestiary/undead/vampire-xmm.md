...
"traits":
  ...
  - "desc": "If the vampire drops to 0 [Hit Points](/Compendium/rules/variant-rules/hit-points-xphb.md)\
      ...
      \ has 0 [Hit Points](/Compendium/rules/variant-rules/hit-points-xphb.md) in\
      ...
      \ to its vampire form and has the [Paralyzed](/Compendium/rules/conditions.md#Paralyzed)\
...
"actions":
  ...
  - "desc": "*Constitution Saving Throw:* DC 17, one creature within 5 feet that is\
      ...
      \ The target's [Hit Point](/Compendium/rules/variant-rules/hit-points-xphb.md)\
...
"bonus_actions":
  - "desc": "If the vampire isn't in sunlight or running water, it shape-shifts into\
      \ a Tiny bat ([Speed](/Compendium/rules/variant-rules/speed-xphb.md) 5 ft.,\
      \ [Fly Speed](/Compendium/rules/variant-rules/fly-speed-xphb.md) 30 ft.) or\
      \ a Medium cloud of mist ([Speed](/Compendium/rules/variant-rules/speed-xphb.md)\
      \ 5 ft., [Fly Speed](/Compendium/rules/variant-rules/fly-speed-xphb.md) 20 ft.\
      ...
      \ other than its size and [Speed](/Compendium/rules/variant-rules/speed-xphb.md),\
      ...
      \ can't pass through liquid. It has [Resistance](/Compendium/rules/variant-rules/resistance-xphb.md)\
