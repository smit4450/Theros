...
![](/Compendium/bestiary/undead/token/flaming-skeleton-xmm.webp#token)
...
***Death Burst.*** The skeleton explodes when it dies. *Dexterity Saving Throw:* DC 12, each creature in a 10-foot [Emanation](/Compendium/rules/variant-rules/emanation-area-of-effect-xphb.md) originating from the skeleton. *Failure:* 14 (`4d6`) Fire damage. *Success:* Half damage.

***Illumination.*** The skeleton sheds [Bright Light](/Compendium/rules/variant-rules/bright-light-xphb.md) in a 15-foot radius and [Dim Light](/Compendium/rules/variant-rules/dim-light-xphb.md) for an additional 15 feet.
