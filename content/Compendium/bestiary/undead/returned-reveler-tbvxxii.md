...
![Returned Reveler](https://img.scryfall.com/cards/art_crop/front/9/e/9ea61098-2c6a-48d2-b99f-f3065c67d8e3.jpg?1593095804#right)  
...
"traits":
  ...
  - "desc": "If the celebrant moves at least 15 feet straight toward a target and then hits it with its ram attack on the same turn, the target takes an extra 5 (2d4) slashing damage. If the target is a creature, it must succeed on a DC 11 Strength saving throw or be knocked prone."
    "name": "Charge"
...
"source":
  - "TBVXXII"
"image": "Compendium/bestiary/undead/token/returned-reveler-tbvxxii.webp"
```
^statblock