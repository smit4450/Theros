...
"traits":
  - "desc": "The dryad’s innate spellcasting ability is Charisma (spell save DC 17).\
      ...
      \ At will: Druidcraft 3/day each: Dispel Magic, Entangle, Plant Growth, Spike\
      \ Growth 1/day each: Moonbeam, grasping vine, wall of thorns"
  ...
  - "desc": "When leading its guild into battle, a dryad rides a magically summoned\
      \ creature woven of living branches, vines, and grasses and imbued with a fey\
      \ spirit."
    "name": "Summoned Mount"
"actions":
  ...
  - "desc": "Melee Weapon Attack: +9 to hit, reach 5 ft., one target. Hit: 12 (2d6\
      ...
      \ DC 17 Dexterity saving throw or become restrained by twisting vines for 1\
      \ minute. A target restrained in this way can use an action to make a DC 17\
      \ Strength (Athletics) or Dexterity (Acrobatics) check, ending the effect on\
      \ itself on a success."
    "name": "Vine Staff"
  ...
  - "desc": "The dryad magically summons a mount, which appears in an unoccupied space\
      ...
      \ stat block of an elk (see the Monster Manual) with these changes: it is a\
      \ plant instead of a beast, it has an Intelligence of 6, and it understands\
      \ Sylvan but can’t speak. While within 1 mile of the mount, the dryad can communicate\
  ...
  - "desc": "The dryad targets one magic item it can see within 120 feet of it. If\
      ...
      \ 10 minutes, until the dryad is incapacitated or dies, or until the dryad uses\
