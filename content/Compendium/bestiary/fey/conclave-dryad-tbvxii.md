...
"cr": "9"
"traits":
  - "desc": "The dryad’s innate spellcasting ability is Charisma (spell save DC 17). The dryad can innately cast the following spells, requiring no material components: At will: [Druidcraft](Compendium/spells/druidcraft-xphb.md) 3/day each: [Dispel Magic](Compendium/spells/dispel-magic-xphb.md), [Entangle](Compendium/spells/entangle-xphb.md), [Plant Growth](Compendium/spells/plant-growth-xphb.md), [Spike Growth](Compendium/spells/spike-growth-xphb.md) 1/day each: [Moonbeam](Compendium/spells/moonbeam-xphb.md), grasping vine, wall of thorns"
...
"actions":
  ...
  - "desc": "The dryad targets one magic item it can see within 120 feet of it. If the magic item isn’t an artifact, its magical properties are suppressed for 10 minutes, until the dryad is [incapacitated](Compendium/rules/conditions.md#Incapacitated) or dies, or until the dryad uses a bonus action to end the effect."
