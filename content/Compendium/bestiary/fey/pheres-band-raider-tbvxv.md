...
statblock: inline
aliases: ["Pheres-Band Raider"]
---
# Pheres-Band Raider
*Source: Theros Bestiary TBVXV*  

<blockquote><small>“Who can deny the call to battle when it sings in our blood?”</small></blockquote>

![Pheres-Band Raider](https://img.scryfall.com/cards/art_crop/front/8/0/80856020-f569-4d73-8c44-7b48535a69e8.jpg?1593092589#right)  

```statblock
"name": "Pheres-Band Raider (TBVXV)"
"size": "Medium"
"type": "fey"
"subtype": "centaur"
...
"actions":
  ...
  - "desc": "_Melee or Ranged Weapon Attack:_ +6 to hit, reach 5 ft. or range 20/60 ft., one target. _Hit:_ 5 (1d6 + 2) piercing damage in melee, or 4 (1d6 + 1) piercing damage at range."
    "name": "Spear"
  - "desc": "The centaur bows down to any manifestation or statue of Kruphix that it can see. It remains in this position until a different action is used."
    "name": "Bow"
"reactions":
  - "desc": "At the beginning of the centaur's turn, if Kruphix saw it bowing to him or an image of him at any point since the centaur's last turn, Kruphix uses a bonus action to summon two **nyxborn centaurs** that appear in unoccupied spaces that the centaur can see within 60 feet of itself. The summoned centaurs act as allies to their summoner and to each other."
    "name": "Inspired"
"source":
  - "TBVXV"
"image": "Compendium/bestiary/fey/token/pheres-band-raider-tbvxv.webp"
```
^statblock