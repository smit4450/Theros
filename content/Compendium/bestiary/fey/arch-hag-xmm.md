...
"traits":
  ...
  - "desc": "When the hag drops to 0 [Hit Points](/Compendium/rules/variant-rules/hit-points-xphb.md),\
      ...
      \ of the space it left is cursed. Until the curse ends, a creature has [Disadvantage](/Compendium/rules/variant-rules/disadvantage-xphb.md)\
...
"regional_effects":
  - "desc": "The region containing an arch-hag's lair is altered by its presence,\
      ...
      \ check they make when they take the [Influence](/Compendium/rules/actions.md#Influence)\
