...
"traits":
  - "desc": "The woe strider's open mouth creates an area of antimagic, as in the\
      \ [antimagic field](/Compendium/spells/antimagic-field-xphb.md) spell, in a\
      \ 60-foot cone. At the start of each of its turns, the woe strider decides which\
...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +7 to hit, reach 10 ft., one target. *Hit:* 7\
    ...
    "name": "Claw"
  - "desc": "*Melee Weapon Attack:* +7 to hit, reach 5 ft., one creature that is [grappled](/Compendium/rules/conditions.md#Grappled),\
