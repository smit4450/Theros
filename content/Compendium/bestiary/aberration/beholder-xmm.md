...
"actions":
  ...
  - "desc": "The beholder randomly shoots one of the following magical rays at a target\
      ...
      \ has the [Charmed](Compendium/rules/conditions.md#Charmed) condition for 1\
      \ hour or until it takes damage. *Success:* Half damage only.  \n- **2 Paralyzing\
      \ Ray.** *Constitution Saving Throw:* DC 16. *Failure:* The target has the [Paralyzed](Compendium/rules/conditions.md#Paralyzed)\
      ...
      \ Necrotic damage. Until the end of the target's next turn, the target's [Speed](Compendium/rules/variant-rules/speed-xphb.md)\
      \ is halved; the target can't take Reactions; and it can take either an action\
      \ or a [Bonus Action](Compendium/rules/variant-rules/bonus-action-xphb.md) on\
      ...
      \ until the end of its next turn. While [Poisoned](Compendium/rules/conditions.md#Poisoned),\
      ...
      \ the [Restrained](Compendium/rules/conditions.md#Restrained) condition until\
      \ the start of the beholder's next turn or until the beholder has the [Incapacitated](Compendium/rules/conditions.md#Incapacitated)\
      ...
      \ it is a Construct or an Undead). *Failure:* The target has the [Unconscious](Compendium/rules/conditions.md#Unconscious)\
      ...
      \ [Restrained](Compendium/rules/conditions.md#Restrained) condition and repeats\
      \ the save at the end of its next turn if it is still [Restrained](Compendium/rules/conditions.md#Restrained),\
      \ ending the effect on itself on a success. *2Nd Failure:* The target has the\
      \ [Petrified](Compendium/rules/conditions.md#Petrified) condition instead of\
      \ the [Restrained](Compendium/rules/conditions.md#Restrained) condition.  \n\
      ...
      \ force, a 10-foot [Cube](Compendium/rules/variant-rules/cube-area-of-effect-xphb.md)\
      ...
      \ or Success:* The target dies if the ray reduces it to 0 [Hit Points](Compendium/rules/variant-rules/hit-points-xphb.md).\
      \  "
    "name": "Eye Rays"
"bonus_actions":
  - "desc": "The beholder's central eye emits an antimagic wave in a 150-foot [Cone](Compendium/rules/variant-rules/cone-area-of-effect-xphb.md).\
      \ Until the start of the beholder's next turn, that area acts as an [Antimagic\
      \ Field](Compendium/spells/antimagic-field-xphb.md) spell, and that area works\
...
"regional_effects":
  - "desc": "The region containing a beholder's lair is twisted by its presence, creating\
      ...
      \ and its allies) that finishes a [Short Rest](Compendium/rules/variant-rules/short-rest-xphb.md)\
      ...
      \ 1 mile of the lair that makes a [D20 Test](Compendium/rules/variant-rules/d20-test-xphb.md)\
      \ and rolls a 1 has the [Prone](Compendium/rules/conditions.md#Prone) condition.\
...
"source":
  - "XMM"
  - "FRHoF"
"image": "Compendium/bestiary/aberration/token/beholder-xmm.webp"
```
^statblock