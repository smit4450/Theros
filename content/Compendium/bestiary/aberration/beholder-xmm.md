...
"actions":
  ...
  - "desc": "The beholder randomly shoots one of the following magical rays at a target\
      ...
      \ [Charmed](/Compendium/rules/conditions.md#Charmed) condition for 1 hour or\
      \ until it takes damage. *Success:* Half damage only.  \n- **2 Paralyzing Ray.**\
      \ *Constitution Saving Throw:* DC 16. *Failure:* The target has the [Paralyzed](/Compendium/rules/conditions.md#Paralyzed)\
      ...
      \ or a [Bonus Action](/Compendium/rules/variant-rules/bonus-action-xphb.md)\
