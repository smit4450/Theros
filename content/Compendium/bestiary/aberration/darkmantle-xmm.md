...
![](/Compendium/books/monster-manual-2025/img/darkmantle.webp#right)
...
"actions":
  - "desc": "*Melee Attack Roll:* +5, reach 5 ft. *Hit:* 6 (1d6 + 3) Bludgeoning damage,\
      ...
      \ has [Advantage](/Compendium/rules/variant-rules/advantage-xphb.md) on its\
      \ attack rolls. Its [Speed](/Compendium/rules/variant-rules/speed-xphb.md) becomes\
      \ 0, it can't benefit from any bonus to its [Speed](/Compendium/rules/variant-rules/speed-xphb.md),\
    ...
    "name": "Crush"
  - "desc": "Magical [Darkness](/Compendium/rules/variant-rules/darkness-xphb.md)\
      \ fills a 15-foot [Emanation](/Compendium/rules/variant-rules/emanation-area-of-effect-xphb.md)\
...
"source":
  - "XMM"
"image": "/Compendium/bestiary/aberration/token/darkmantle-xmm.webp"
```
^statblock
