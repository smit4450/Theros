...
- monster/cr/3
- monster/size/medium
- monster/type/3rd-level-transmutation-fey/centaur
statblock: inline
...
![](/Compendium/bestiary/miscellaneous/img/nyxborn-centaur.webp#center)

```statblock
"name": "Nyxborn Centaur"
"size": "Medium"
...
"traits":
  ...
  - "desc": "The centaur counts as one size larger when determining its carrying capacity\
    ...
    "name": "Equine Build"
  - "desc": "The centaur can innately see the shape and nature of terrain up to 4\
      \ miles away from itself, ignoring all obstructions."
    "name": "Gift of Kruphix"
  - "desc": "The centaur's attack rolls score a critical hit on a roll of 19 or 20\
      \ on the d20."
    "name": "Improved Critical"
  - "desc": "The centaur's weapon attacks are magical."
    "name": "Magic Weapons"
  - "desc": "In addition to being a creature, the centaur is a 3rd-level divine transmutation\
      \ spell with no target."
    "name": "Spell Nature"
  - "desc": "The centaur glows with the soft light of the night sky, shedding dim\
      \ light in a 15-foot radius."
    "name": "Starlight Form"
  - "desc": "While the centaur is in any of Theros's three realms, it can magically\
      \ convey what it senses to Kruphix."
    "name": "Telepathic Bond"
"actions":
  - "desc": "The centaur makes two attacks."
    "name": "Multiattack"
  - "desc": "Melee Weapon Attack: +5 to hit, one target. Hit: 5 (1d4 + 3) bludgeoning\
      \ damage."
    "name": "Hooves"
