...
"traits":
  ...
  - "desc": "The eidolon's innate spellcasting ability is Wisdom (spell save DC 11, +3 to hit with spell attacks). It can innately cast the following spells, requiring no material components: At will: [Vicious Mockery](Compendium/spells/vicious-mockery-xphb.md), [Confusion](Compendium/spells/confusion-xphb.md), [Enthrall](Compendium/spells/enthrall-xphb.md)"
...
"source":
  - "TBVXXII"
"image": "Compendium/bestiary/miscellaneous/token/eidolon-of-rhetoric-tbvxxii.webp"
```
^statblock