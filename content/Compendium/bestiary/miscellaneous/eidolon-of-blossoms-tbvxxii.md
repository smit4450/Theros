...
"traits":
  - "desc": "Attack rolls against the eidolon are made with [Disadvantage](Compendium/rules/variant-rules/disadvantage-xphb.md) unless the eidolon is [incapacitated](Compendium/rules/conditions.md#Incapacitated)."
    "name": "Blurred Form"
  - "desc": "If the eidolon is within 300 feet of a dryad that isn't [incapacitated](Compendium/rules/conditions.md#Incapacitated) and the eidolon isn't [deafened](Compendium/rules/conditions.md#Deafened), it spends its turns trying to get within 5 feet of a dryad, moving toward the nearest one."
    "name": "Dryad Seeker"
...
"source":
  - "TBVXXII"
"image": "Compendium/bestiary/miscellaneous/token/eidolon-of-blossoms-tbvxxii.webp"
```
^statblock