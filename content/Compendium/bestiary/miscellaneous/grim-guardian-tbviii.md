...
"traits":
  - "desc": "The guardian's weapon attacks are magical."
    "name": "Magic Weapons"
  - "desc": "The Returned has [Advantage](Compendium/rules/variant-rules/advantage-xphb.md) on an attack roll against a creature if at least one of the Returned’s allies is within 5 feet of the creature and the ally isn’t [incapacitated](Compendium/rules/conditions.md#Incapacitated)."
    "name": "Pack Tactics"
...
"source":
  - "TBVIII"
"image": "Compendium/bestiary/miscellaneous/token/grim-guardian-tbviii.webp"
```
^statblock