...
- monster/cr/4
- monster/size/medium
- monster/type/2nd-level-necromancy-undead
statblock: inline
...
![](/Compendium/bestiary/miscellaneous/img/everflame-eidolon.webp#center)
...
"traits":
  ...
  - "desc": "If the eidolon is subjected to an effect that allows it to make a Dexterity\
      ...
      \ if it succeeds on the saving throw, and only half damage if it fails. It can’\
      t use this trait if it’s incapacitated."
    "name": "Evasion"
  - "desc": "At the start of each of the eidolon's turns, if the eidolon is ignited,\
      \ each creature within 5 feet of it takes 10 (3d6) fire damage, and flammable\
      \ objects in the aura that aren't being worn or carried ignite. A creature that\
      \ touches the eidolon or hits it with a melee attack while within 5 feet of\
      \ it takes 10 (3d6) fire damage."
    "name": "Fire Aura (Ignited Only)"
  - "desc": "As a bonus action, the eidolon can set itself ablaze or extinguish its\
      \ flames. While ablaze, the eidolon sheds bright light in a 10-foot radius and\
  ...
  - "desc": "In addition to being a creature, the eidolon is a 2nd-level divine necromancy\
