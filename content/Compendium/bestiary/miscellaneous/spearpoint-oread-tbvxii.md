...
"traits":
  - "desc": "The oread can move across difficult terrain made of earth or stone without expending extra movement."
    "name": "Earth Walk"
  - "desc": "The oread's innate spellcasting ability is Charisma (spell save DC 14, +6 to hit with spell attacks). It can innately cast the following spells, requiring no material components: At will: [Passwall](Compendium/spells/passwall-xphb.md), [Find The Path](Compendium/spells/find-the-path-xphb.md) 3/day: [Stone Shape](Compendium/spells/stone-shape-xphb.md) 1/day: [Hallucinatory Terrain](Compendium/spells/hallucinatory-terrain-xphb.md), [Wall Of Stone](Compendium/spells/wall-of-stone-xphb.md), [Creation](Compendium/spells/creation-xphb.md)"
