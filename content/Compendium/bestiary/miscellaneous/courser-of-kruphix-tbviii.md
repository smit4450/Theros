...
![](/Compendium/bestiary/miscellaneous/img/courser-of-kruphix.webp#center)
...
"traits":
  ...
  - "desc": "The courser counts as one size larger when determining its carrying capacity\
    ...
    "name": "Equine Build"
  - "desc": "The courser can innately see the shape and nature of terrain up to 4\
  ...
  - "desc": "The courser's weapon attacks are magical."
    "name": "Magic Weapons"
  - "desc": "In addition to being a creature, the courser is a 3rd-level divine transmutation\
      \ spell with no target."
    "name": "Spell Nature"
  - "desc": "The courser glows with the soft light of the night sky, shedding dim\
      \ light in a 15-foot radius."
    "name": "Starlight Form"
  - "desc": "While the courser is in any of Theros's three realms, it can magically\
      \ convey what it senses to Kruphix."
    "name": "Telepathic Bond"
"actions":
  - "desc": "The courser makes two attacks."
    "name": "Multiattack"
  - "desc": "Melee Weapon Attack: +4 to hit, one target. Hit: 8 (1d4 + 6) bludgeoning\
      \ damage."
    "name": "Hooves"
  - "desc": "_Melee Weapon Attack:_ +4 to hit, reach 10 ft., one target. _Hit:_ 11\
