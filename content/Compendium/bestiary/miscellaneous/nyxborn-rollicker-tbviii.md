...
![Nyxborn Rollicker](https://img.scryfall.com/cards/art_crop/front/b/2/b2081bf0-09f5-4c95-b4cc-48a8784294d4.jpg?1593092278#right)  

```statblock
"name": "Nyxborn Rollicker (TBVIII)"
"size": "Medium"
"type": "1st-level transmutation  fey"
"subtype": "satyr"
...
"traits":
  ...
  - "desc": "In addition to being a creature, the satyr is a 1st-level divine transmutation spell with no target."
    "name": "Spell Nature"
...
"actions":
  - "desc": "The satyr makes two ram attacks or two stick attacks."
    "name": "Multiattack"
  - "desc": "Melee Weapon Attack: +3 to hit, reach 5 ft., one target. Hit: 6 (2d4 + 1) bludgeoning damage."
    "name": "Ram"
  - "desc": "_Melee Weapon Attack:_ +3 to hit, reach 5 ft., one target. _Hit:_ 3 (1d4 + 1) bludgeoning damage, or 4 (1d6 + 1) bludgeoning damage if used with two hands to make a melee attack."
    "name": "Stick"
"source":
  - "TBVIII"
"image": "Compendium/bestiary/miscellaneous/token/nyxborn-rollicker-tbviii.webp"
```
^statblock