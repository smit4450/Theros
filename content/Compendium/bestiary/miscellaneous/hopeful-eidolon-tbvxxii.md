...
- monster/cr/1
- monster/size/medium
- monster/type/1st-level-necromancy-undead
aliases:
- "Hopeful Eidolon"
---
# Hopeful Eidolon
*Source: Theros Bestiary, Vol. XXII*  
![](/Compendium/bestiary/miscellaneous/img/hopeful-eidolon.webp#center)

```ad-statblock
title: Hopeful Eidolon
*Medium 1st-level necromancy undead, Any alignment*
...
***Spell Nature.*** In addition to being a creature, the eidolon is a level 1 divine necromancy spell with no target. Its weapon attacks are magical, and it glows with the soft light of the night sky, shedding dim light in a 15-foot radius.

***Turn Resistance.*** The eidolon has Advantage on saving throws against any effect that turns undead.

***Undead Nature.*** The eidolon doesn’t require air, food, drink, or sleep.

## Actions

***Life Drain.*** Melee Weapon Attack: +6 to hit, reach 5 ft., one target. Hit: 7 (1d4 + 4) necrotic damage. The eidolon regains life equal to that amount.
```
^statblock