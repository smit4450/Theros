...
![Soul of Theros](https://img.scryfall.com/cards/art_crop/front/6/3/63e391d3-cf19-4f73-9d39-22587e0f3c0d.jpg?1562788050#right)  
...
"cr": "27"
"traits":
  - "desc": "As a bonus action on its turn, the avatar chooses any number of creatures on Theros. Until the beginning of the avatar's next turn, those creatures each get a +2 bonus to Strength and Dexterity checks and damage rolls, gain 4 (1d8) temporary [Hit Points](Compendium/rules/variant-rules/hit-points-xphb.md), and have [Advantage](Compendium/rules/variant-rules/advantage-xphb.md) on attack rolls. For every point of damage dealt by those creatures until the avatar's next turn, it regains 1 hit point."
...
"actions":
  - "desc": "The avatar makes three melee attacks."
    "name": "Multiattack"
  - "desc": "Melee Weapon Attack: +14 to hit, reach 5 ft., one creature. Hit: 36 (12d4 + 6) bludgeoning damage. If the target is a Medium or smaller creature, it must succeed on a DC 22 Strength saving throw or be knocked [prone](Compendium/rules/conditions.md#Prone)."
    "name": "Shield Bash"
...
"source":
  - "TBVVI"
"image": "Compendium/bestiary/celestial/token/soul-of-theros-tbvvi.webp"
```
^statblock