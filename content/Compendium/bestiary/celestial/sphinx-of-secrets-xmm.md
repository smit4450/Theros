...
"actions":
  - "desc": "The sphinx makes three Claw attacks. It can replace one attack with a\
      \ use of [Curse](/Compendium/rules/variant-rules/curses-xphb.md) of the Riddle."
    "name": "Multiattack"
  ...
  - "desc": "*Intelligence Saving Throw:* DC 15, one creature the sphinx can see within\
      ...
      \ a riddle. The cursed target has [Disadvantage](/Compendium/rules/variant-rules/disadvantage-xphb.md)\
      \ on ability checks and attack rolls. In addition, if it takes the [Magic](/Compendium/rules/actions.md#Magic)\
      \ action, it must succeed on a DC 15 Intelligence saving throw or that action\
      \ is wasted. The cursed target can take a Study action to make a DC 15 Intelligence\
      \ check, solving the riddle and ending the curse on a success. The curse ends\
  ...
  - "desc": "The sphinx casts one of the following spells, requiring no Material components\
      ...
      **At will:** [Detect Magic](/Compendium/spells/detect-magic-xphb.md), [Identify](/Compendium/spells/identify-xphb.md),\
      \ [Prestidigitation](/Compendium/spells/prestidigitation-xphb.md)\n\n**1/day\
      \ each:** [Locate Object](/Compendium/spells/locate-object-xphb.md), [Remove\
