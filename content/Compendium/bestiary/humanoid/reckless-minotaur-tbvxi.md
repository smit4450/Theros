...
![Reckless Minotaur](https://img.scryfall.com/cards/art_crop/front/9/3/938272b2-8e1c-4196-8557-c597735dd96e.jpg?1562639929#right)  

```statblock
"name": "Reckless Minotaur (TBVXI)"
"size": "Medium"
"type": "humanoid"
"subtype": "minotaur"
...
"actions":
  - "desc": "_Melee Weapon Attack:_ +6 to hit, reach 5 ft., one target. _Hit:_ 6 (1d6 + 4) piercing damage, and the minotaur can use a bonus action to attempt to shove that target with its horns. The target must be within 5 feet of the minotaur and Large or smaller. Unless the target succeeds on a DC 14 Strength saving throw, the minotaur pushes it up to 10 feet away from the minotaur."
    "name": "Horns"
"source":
  - "TBVXI"
"image": "Compendium/bestiary/humanoid/token/reckless-minotaur-tbvxi.webp"
```
^statblock