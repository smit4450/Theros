...
"cr": "1"
"traits":
  - "desc": "The oracle has [Advantage](Compendium/rules/variant-rules/advantage-xphb.md) on initiative rolls."
  ...
  - "desc": "The oracle of bones is a 9th-level spellcaster. The oracle of bones's spellcasting ability is Wisdom (spell save DC 13, +5 to hit with spell attacks). The oracle of bones has the following cleric spells prepared: Cantrip (at will): _guidance_, [Sacred Flame](Compendium/spells/sacred-flame-xphb.md), [Spare The Dying](Compendium/spells/spare-the-dying-xphb.md) 2nd level (3 slots): [Augury](Compendium/spells/augury-xphb.md) 4th level (3 slots): [Divination](Compendium/spells/divination-xphb.md) 5th level (1 slots): _commune_"
    "name": "Spellcasting"
"actions":
...
"reactions":
  ...
  - "desc": "Immediately after initiative rolls in which the oracle participates, it demands tribute from a creature it can see. That creature may bow, genuflect, salute, or perform a similar gesture as a bonus action. If tribute is paid: Until the end of combat, the oracle gains a +2 bonus to damage rolls and Strength and Dexterity checks, and 9 (2d8) temporary [Hit Points](Compendium/rules/variant-rules/hit-points-xphb.md). If tribute isn't paid: The oracle casts a [Sacred Flame](Compendium/spells/sacred-flame-xphb.md) on that creature."
    "name": "Demand Tribute"
"source":
  - "TBVXX"
