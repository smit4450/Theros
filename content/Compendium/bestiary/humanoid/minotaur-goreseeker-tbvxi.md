...
![Minotaur Goreseeker](https://img.scryfall.com/cards/art_crop/front/3/d/3d2f2bcc-0db9-4aa1-b63d-587c62468015.jpg?1562639757#right)  

```statblock
"name": "Minotaur Goreseeker (TBVXI)"
"size": "Medium"
"type": "humanoid"
"subtype": "minotaur"
...
"actions":
  - "desc": "The minotaur makes two attacks: one with its horns and one with its claw."
    "name": "Multiattack"
  - "desc": "_Melee Weapon Attack:_ +5 to hit, reach 5 ft., one target. _Hit:_ 6 (1d6 + 3) piercing damage, and the minotaur can use a bonus action to attempt to shove that target with its horns. The target must be within 5 feet of the minotaur and Large or smaller. Unless the target succeeds on a DC 13 Strength saving throw, the minotaur pushes it up to 10 feet away from the minotaur."
    "name": "Horns"
  - "desc": "_Melee Weapon Attack:_ +5 to hit, reach 5 ft., one target. _Hit:_ 8 (2d4 + 3) slashing damage."
    "name": "Claw"
"source":
  - "TBVXI"
"image": "Compendium/bestiary/humanoid/token/minotaur-goreseeker-tbvxi.webp"
```
^statblock