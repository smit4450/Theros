...
![](/Compendium/bestiary/humanoid/img/borderland-minotaur.webp#right)
...
"actions":
  - "desc": "The warrior can attack twice, instead of once, whenever it takes the\
    ...
    "name": "Extra Attack"
  - "desc": "_Melee Weapon Attack:_ +9 to hit, reach 5 ft., one target. _Hit:_ 7 (1d6\
      \ + 4) piercing damage, and the warrior can use a bonus action to attempt to\
      ...
      \ on a DC 15 Strength saving throw, the warrior pushes it up to 10 feet away\
      \ from the warrior."
    "name": "Horns"
  - "desc": "_Melee Weapon Attack:_ +9 to hit, reach 5 ft., one target. _Hit:_ 7 (1d6\
      \ + 4) piercing damage."
