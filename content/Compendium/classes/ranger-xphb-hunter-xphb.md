...
Your tenacity can wear down even the most resilient foes. When you hit a creature with a weapon, the weapon deals an extra `1d8` damage to the target if it's missing any of its [[hit-points-xphb|Hit Points]]. You can deal this extra damage only once per turn.
...
When you take damage, you can take a [[reaction-xphb|Reaction]] to give yourself [[resistance-rules-xphb|Resistance]] to that damage and any other damage of the same type until the end of the current turn.