...
![The Sorcerer Delina manipulates wild magic to create unpredictable wonders](/Compendium/classes/img/112-04-027-delina.webp#center)
...
**Spell Slots.** The Sorcerer Features table shows how many spell slots you have to cast your level 1+ spells. You regain all expended slots when you finish a [Long Rest](/Compendium/rules/variant-rules/long-rest-xphb.md).

**Prepared Spells of Level 1+.** You prepare the list of level 1+ spells that are available for you to cast with this feature. To start, choose two level 1 Sorcerer spells. [Burning Hands](/Compendium/spells/burning-hands-xphb.md) and [Detect Magic](/Compendium/spells/detect-magic-xphb.md) are recommended.
...
**Spellcasting Focus.** You can use an [Arcane Focus](/Compendium/items/arcane-focus-xphb.md) as a [Spellcasting Focus](/Compendium/rules/variant-rules/spellcasting-focus-xphb.md) for your Sorcerer spells.
...
**Creating Spell Slots.** As a [Bonus Action](/Compendium/rules/variant-rules/bonus-action-xphb.md), you can transform unexpended Sorcery Points into one spell slot. The Creating Spell Slots table shows the cost of creating a spell slot of a given level, and it lists the minimum Sorcerer level you must be to create a slot. You can create a spell slot no higher than level 5.
...
- [Careful Spell](/Compendium/optional-features/careful-spell-xphb.md)  
- [Distant Spell](/Compendium/optional-features/distant-spell-xphb.md)  
- [Empowered Spell](/Compendium/optional-features/empowered-spell-xphb.md)  
- [Extended Spell](/Compendium/optional-features/extended-spell-xphb.md)  
- [Heightened Spell](/Compendium/optional-features/heightened-spell-xphb.md)  
- [Quickened Spell](/Compendium/optional-features/quickened-spell-xphb.md)  
- [Seeking Spell](/Compendium/optional-features/seeking-spell-xphb.md)  
- [Subtle Spell](/Compendium/optional-features/subtle-spell-xphb.md)  
- [Transmuted Spell](/Compendium/optional-features/transmuted-spell-xphb.md)  
- [Twinned Spell](/Compendium/optional-features/twinned-spell-xphb.md)  
