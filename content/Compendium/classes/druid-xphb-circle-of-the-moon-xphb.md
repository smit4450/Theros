...
![](/Compendium/classes/img/moon-druid.webp#right)
...
**Challenge Rating.** The maximum [Challenge Rating](/Compendium/rules/variant-rules/challenge-rating-xphb.md) for the form equals your Druid level divided by 3 (round down).
...
**Temporary Hit Points.** You gain a number of [Temporary Hit Points](/Compendium/rules/variant-rules/temporary-hit-points-xphb.md) equal to three times your Druid level.
...
You magically transport yourself, reappearing amid a burst of moonlight. As a [Bonus Action](/Compendium/rules/variant-rules/bonus-action-xphb.md), you teleport up to 30 feet to an unoccupied space you can see, and you have [Advantage](/Compendium/rules/variant-rules/advantage-xphb.md) on the next attack roll you make before the end of this turn.

You can use this feature a number of times equal to your Wisdom modifier (minimum of once), and you regain all expended uses when you finish a [Long Rest](/Compendium/rules/variant-rules/long-rest-xphb.md). You can also regain uses by expending a level 2+ spell slot for each use you want to restore (no action required).
