...
![Archmages of Greyhawk—Jallarzi, Mordenkainen, and Bigby—prepare their magic as they open a gate to another plane](/Compendium/books/players-handbook-2024/img/181-08-001-jallarzi-mordenkainen-bigby.webp#center)
...
Finishing a [Long Rest](/Compendium/rules/variant-rules/long-rest-xphb.md) restores any expended spell slots.
...
Certain spells—including a spell cast as a [Ritual](/Compendium/rules/variant-rules/ritual-xphb.md)—require more time to cast: minutes or even hours. While you cast a spell with a casting time of 1 minute or more, you must take the [Magic](/Compendium/rules/actions.md#Magic) action on each of your turns, and you must maintain [Concentration](/Compendium/rules/conditions.md#Concentration) while you do so. If your Concentration is broken, the spell fails, but you don't expend a spell slot. To cast the spell again, you must start over.
...
![An aasimar Wizard uses a crystal material component to focus the magic of Cone of Cold](/Compendium/books/players-handbook-2024/img/182-08-002-aasimar-wizard.webp#center)
...
If a spell doesn't consume its materials and doesn't specify a cost for them, a spellcaster can use a [Component Pouch](/Compendium/items/component-pouch-xphb.md) (see "chapter 6") instead of providing the materials specified in the spell, or the spellcaster can substitute a [Spellcasting Focus](/Compendium/rules/variant-rules/spellcasting-focus-xphb.md) if the caster has a feature that allows that substitution. To use a Component Pouch, you must have a hand free to reach into it, and to use a [Spellcasting Focus](/Compendium/rules/variant-rules/spellcasting-focus-xphb.md), you must hold it unless its description says otherwise (see "chapter 6" for descriptions).
