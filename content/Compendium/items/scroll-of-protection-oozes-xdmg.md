...
# Scroll of Protection (Oozes)
*Scroll, rare*  
![](/Compendium/items/img/scroll-of-protection.webp#right)
...
As a [Magic](/Compendium/rules/actions.md#Magic) action, a creature within 5 feet of the [Emanation](/Compendium/rules/variant-rules/emanation-area-of-effect-xphb.md) can attempt to overcome it, which forces the creature to make a DC 15 Charisma saving throw. On a successful save, the creature ceases to be affected by the [Emanation](/Compendium/rules/variant-rules/emanation-area-of-effect-xphb.md).
