...
| 86-95 | You can take a [[bonus-action-xphb|Bonus Action]] to cause the *Moonblade* to flash brightly. Each other creature that is within 30 feet of you and not behind [[cover-table-xphb|Total Cover]] must succeed on a DC 15 Constitution saving throw or have the [[conditions#Blinded|Blinded]] condition for 1 minute. A creature repeats the save at the end of each of its turns, ending the effect on itself on a success. You can't use this property again until you finish a [[short-rest-xphb|Short]] or [[long-rest-xphb|Long Rest]]. |
