...
Opening the bottle causes thick smoke to billow out, forming a cloud that fills a 60-foot [Emanation](/Compendium/rules/variant-rules/emanation-area-of-effect-xphb.md) originating from the bottle. The area within the smoke is [Heavily Obscured](/Compendium/rules/variant-rules/heavily-obscured-xphb.md).

Each minute the bottle remains open, the size of the [Emanation](/Compendium/rules/variant-rules/emanation-area-of-effect-xphb.md) increases by 10 feet until it reaches its maximum size of 120 feet.
