...
A target that fails its saving throw is [stunned](Compendium/rules/conditions.md#Stunned) instead of [incapacitated](Compendium/rules/conditions.md#Incapacitated).
