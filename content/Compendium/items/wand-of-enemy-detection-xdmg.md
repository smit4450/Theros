...
This wand has 7 charges. While holding it, you can take a [Magic](/Compendium/rules/actions.md#Magic) action to expend 1 charge. For 1 minute, you know the direction of the nearest creature [Hostile](/Compendium/rules/variant-rules/hostile-attitude-xphb.md) to you within 60 feet, but not its distance from you. The wand can sense the presence of [Hostile](/Compendium/rules/variant-rules/hostile-attitude-xphb.md) creatures that are [Invisible](/Compendium/rules/conditions.md#Invisible), ethereal, disguised, or hidden, as well as those in plain sight. The effect ends if you stop holding the wand.
