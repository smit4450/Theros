...
---
# Bident of Thassa's Beloved
*Weapon (trident), artifact (requires attunement by a creature that worships Thassa)*
...
| d4 | Effect |
| --- | --- |
| 1 | You gain a creature companion as if using a conjure animals spell. The creature is a giant sea horse if you're underwater, otherwise it's a warhorse. |
