...
The Book of Vile Darkness remains with you only as long as you strive to work evil in the world. If you fail to perform at least one evil act within the span of 10 days, or if you willingly perform a good act, the book disappears, your [Attunement](/Compendium/rules/variant-rules/attunement-xphb.md) to it ends immediately, and you lose all benefits granted by it. If you die while attuned to the book, an entity of great evil claims your soul. You can't be restored to life by any means while your soul remains imprisoned.
...
While the book is on your person, you have [Immunity](/Compendium/rules/variant-rules/immunity-xphb.md) to the [Exhaustion](/Compendium/rules/conditions.md#Exhaustion) condition.
...
You can reference the Book of Vile Darkness whenever you make an Intelligence check to recall information about some aspect of evil, such as lore about demons. When you do so, you have [Advantage](/Compendium/rules/variant-rules/advantage-xphb.md) on that check.
...
If a [solar](/Compendium/bestiary/celestial/solar-xmm.md) tears the book in two, the book is destroyed for `1d100` years, after which it re-forms in some far corner of the multiverse.
