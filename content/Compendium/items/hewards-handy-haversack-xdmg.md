...
Retrieving an item from the haversack requires a [Utilize](/Compendium/rules/actions.md#Utilize) action or a [Bonus Action](/Compendium/rules/variant-rules/bonus-action-xphb.md) (your choice). When you reach into the haversack for a specific item, the item is always magically on top.
